...
public class TestSuite extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
       ...
       //2.4 Click on "Add To Cart"
        ...
        Assert.assertEquals(actualText, expectedText, "Message displayed");
      ...
      //2.8 Select HDD radio "400 GB [+$100.00]"
        computersPage.clickHdd();

      //2.9	Select OS radio "Vista Premium [+$60.00]"
        computersPage.clickOs();

     //2.10	Check Two Check boxes "Microsoft Office [+$50.00]" and "Total Commander [+$5.00]"
        //computersPage.setMicrosoftOfficeCheckBox();
        Thread.sleep(2000);
        computersPage.setTotalCommanderCheckbox();

    //2.11 Verify the price "$1,475.00"

        String expectedText1 = "$1,475.00";
        String actualText1 = computersPage.verifyThePrice();
