...
public class ComputersPage extends Utility {
    ...
    By buildYourOwn = By.xpath("//h1[contains(text(),'Build your own computer')]");
    ...
    By osLink = By.xpath("//input[@id='product_attribute_4_9']");
    ...
    By addToCartLink1 = By.xpath("//button[@id='add-to-cart-button-1']");
    ...
    public String buildYourOwnComputer(){
      return  getTextFromElement(buildYourOwn);
